...
import com.peter.vaadin.components.vaadin.chart.lineandscatter.SplineUpdatingEachSecond;
...
import com.peter.vaadin.components.vaadin.chart.timeline.CandlestickUpdatingEachSecond;
...
public class MyUI extends UI {
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        CandlestickUpdatingEachSecond candlestickUpdatingEachSecond = new CandlestickUpdatingEachSecond();
        ...
        layout.addComponent(candlestickUpdatingEachSecond);
        layout.addComponent(splineUpdatingEachSecond);
